    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-background/80">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-20 flex flex-col items-center">
          <div className="inline-flex items-center gap-2 rounded-full bg-primary/10 px-4 py-1.5 text-sm font-medium mb-6 bg-teal-200">
            <Sparkles className="h-4 w-4" />
            <span>AI-Powered Learning Experience</span>
          </div>

          <h1 className="text-5xl md:text-6xl font-bold tracking-tight text-center bg-clip-text text-transparent bg-gradient-to-r from-black to-black/70 mb-4 p-3">
            AI Learning Platform
          </h1>

          <p className="mt-2 text-xl text-muted-foreground text-center max-w-2xl mb-12">
